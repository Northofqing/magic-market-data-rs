...
- The official exchange implementation plan is written and the new SSE/SZSE announcement crate
  is under test-first implementation.
...
- Official exchange Tasks 1-3 are implemented and live-probed; root Router validation,
  integration/deployment/performance documentation, CI, compliance and the two additional release
  binaries are now integrated. Independent exchange review and full-workspace release gates remain.
