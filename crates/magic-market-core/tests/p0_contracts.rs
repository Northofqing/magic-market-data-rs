...
fn normalized_bar_rejects_unparseable_market_times() {
    ...
    assert!(make("2026-07-22 09:30:00", "2026-07-22 09:31:01").is_err());
    assert!(make("2026-07-22 23:59:59", "2026-07-23 00:00:00").is_err());
    assert!(make("2026-07-22 09:30:00", "2026-07-22 09:31:00").is_ok());
}
