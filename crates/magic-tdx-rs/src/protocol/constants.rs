...
pub const PRIMARY_SERVERS: &[(&str, &str, u16)] = &[
    ("杭州联通J2", "60.12.136.250", 7709),  // 联通
    ("华林5", "218.106.92.182", 7709),      // 华林
    ("杭州电信J3", "218.75.126.9", 7709),   // 电信
    ("上海电信Z1", "180.153.18.170", 7709), // 电信
    ("华林7", "220.178.55.71", 7709),       // 华林
    ("杭州电信J2", "115.238.56.198", 7709), // 电信
    ("杭州电信J1", "60.191.117.167", 7709), // 电信
    ("杭州电信J4", "115.238.90.165", 7709), // 电信
    ("华林6", "218.106.92.183", 7709),      // 华林
    ("安信15", "59.36.5.11", 7709),         // 安信
];
