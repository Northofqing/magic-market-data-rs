...
use magic_market_core::{Announcements, InvestorQuestions, MarketAnnouncements};
...
fn assert_market_provider<T: MarketAnnouncements<Error = CninfoError>>() {}
...
fn public_traits_and_capabilities_match_the_implementation() {
    ...
    assert_market_provider::<CninfoClient>();
