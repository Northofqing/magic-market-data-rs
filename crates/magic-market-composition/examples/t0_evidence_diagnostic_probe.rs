...
use magic_market_composition::{
    production_operation_registry, T0EvidenceRecord, T0EvidenceRequest, T0_EVIDENCE_REQUEST_SCHEMA,
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for sequence in 1..=requests {
        let requested_at = OffsetDateTime::now_utc().format(&Rfc3339)?;
        ...
        println!(
            "t0_evidence sequence={sequence} instrument={} requested_at={} quote_status={:?} book_status={:?} daily_bars={} five_minute_bars={} evidence={} observed_at={} source_at={:?} admitted={} complete={} blocker={:?} digest={}",
