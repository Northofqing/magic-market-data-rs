...
use magic_market_core::{
    unix_seconds_to_china_rfc3339, AssetClass, ContentCapabilities, DataBatch, Exchange, HttpsUrl,
    InstrumentDateRangeRequest, InstrumentId, LoadProbeSnapshot, NewsItem, NewsProvider,
    NonEmptyText, PositiveU32, ProbeRequestTracker, Provenance, ProviderId, SourceEvidence,
};
use md5::{Digest, Md5};
...
fn parse_item(
    ...
    let published_at = unix_seconds_to_china_rfc3339(ctime)?;
